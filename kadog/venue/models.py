...
class Venue(models.Model):
    ...
    events = models.ManyToManyField('events.PetEntertainment', through='VenueEventsParticipant')
...
class VenueEventsParticipant(models.Model):
    ...
    event = models.ForeignKey('events.PetEntertainment', on_delete=models.CASCADE)
